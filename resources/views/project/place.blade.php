...
<!-- 		<div class="container">
	...
	<div class="wrapper" id="panel" style="width:100%;">
		<div id="theSidebar" class="sidebar">
			<div class="logo">
				<a href="/"><img src="{{ asset('/assets/img/icon/logo.png') }}"></a>
			</div>
			...
			<section class="grid" id="container">
				...
				@foreach ($places as $place)
					<a class="grid__item" href="#">
						<h2 class="title title--preview">{{ $place->name }}</h2>
						<div class="loader"></div>
						<span class="category">{{ $place->region }}</span>
						<div class="meta meta--preview">
							<img class="lazy meta__avatar" data-original="{{ asset('content/place')."/".$place->name.".jpg" }}" alt="图片暂缺" src="{{ asset('/assets/img/icon/logo.png') }}" onerror="imgError(this);">
						</div>
					</a>
				@endforeach
			</section>
			...
			<section class="content">
				...
				@foreach ($places as $place)
					<article class="content__item">
						<div class="meta meta--full">
							<img src="{{ asset('/assets/img/icon/logo.png') }}" style="width:236px; height: 38px; vertical-align: middle" >

							<img class="meta__avatar" data-src="{{ asset('content/place')."/".$place->name.".jpg" }}" alt="图片暂缺" onerror="imgError(this);">

							<span class="meta__subTitle">{{$place->name}}</span>

							<div class="meta__misc--seperator">
								<ul>
									<li>管 辖 区 ：{{ $place-> region}}</li>
									<li>普通话音 ：{{ $place-> mandarin}}</li>	
									<li>北 京 音 ：{{ $place->beijing}}</li>
									<li>繁    体 ：{{ $place-> traditional}}</li>
								</ul>
							</div>
						...
						<div class="picture">
							<img class="pic_photo" data-src="{{ asset('content/place')."/".$place->name.".jpg" }}" alt="图片暂缺" onerror="imgError(this);"/>
						</div>

						<div class="detail" style="max-height: calc(85vh - 60px); overflow: auto;">
							<h2 class="title title--full">{{ $place->name }}</h2>
