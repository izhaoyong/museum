  ...
  <div class="row">
    <div class="col-md-10 col-md-offset-1">
      <div class="panel panel-default">
        <div class="panel-heading">新增口传文化</div>
        ...
        <div class="panel-body">
          ...
          <form action="{{ URL('admin/oral') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" name="speaker" id="oralspeaker" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="xml" id="oralxml" class="form-control">
              <hr>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" name="content" id="oralcontent" class="form-control">
            </div>
            ...
            <button class="btn btn-lg btn-info">新增口传文化</button>
          </form>
